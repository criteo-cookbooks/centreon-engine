...
when 'redhat', 'centos'
  ...
  default['centreon_engine']['ces-standard']['baseurl'] = "http://yum.centreon.com/standard/3.4/el$releasever/stable/$basearch/"
  default['centreon_engine']['ces-standard']['gpgcheck'] = true
  default['centreon_engine']['ces-standard']['enabled'] = true
  default['centreon_engine']['ces-standard']['gpgkey'] = "http://yum.centreon.com/standard/3.4/el$releasever/stable/RPM-GPG-KEY-CES"
  ...
  default['centreon_engine']['ces-standard-noarch']['baseurl'] = "http://yum.centreon.com/standard/3.4/el$releasever/stable/noarch/"
  default['centreon_engine']['ces-standard-noarch']['gpgcheck'] = true
  default['centreon_engine']['ces-standard-noarch']['enabled'] = true
  default['centreon_engine']['ces-standard-noarch']['gpgkey'] = "http://yum.centreon.com/standard/3.4/el$releasever/stable/RPM-GPG-KEY-CES"
